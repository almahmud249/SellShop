                ...
                <ul class="clearfix right floatright">
                  ...
                  <li v-else>
                    ...
                    <ul>
                      ...
                      <li>
                        <router-link to="/UserRegister" href="login.html"
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <router-link href="#" :to="`/wishList/${allusers.id}`">My wishlist</router-link>
                      </li>
                      <li>
      ...
      <div class="container text-center">
        <div class="row">
          <div class="col-sm-2">
            <div class="logo">
              <a href="index.html"
                ><img src="asset/img/logo2.png" alt="Sellshop"
              /></a>
            </div>
          </div>
          <div class="col-sm-8">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ul class="magamenu">
                        ...
                        <li class="banner">
                          <a href="shop.html"
                            ><img src="asset/img/maga2.png" alt=""
                          /></a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul class="dropdown">
                        ...
                        <li>
                          <a href="product-grid.html">Product Grid View</a>
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul class="dropdown">
                        <li>
                          <a href="blog-style-1.html">Blog Style One</a>
                        </li>
                        <li>
                          <a href="blog-style-2.html">Blog Style Two</a>
                        </li>
                        <li>
