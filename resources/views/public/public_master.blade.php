...
<head>
    ...
    <!-- pe-icon-7-stroke -->
    <link rel="stylesheet" href="{{ asset('asset/css') }}/jquery.simpleLens.css">
    <!-- jquery-ui.min css -->
    <link rel="stylesheet" href="{{ asset('asset/css') }}/jquery-ui.min.css">
    <!-- meanmenu css -->
    <link rel="stylesheet" href="{{ asset('asset/css') }}/meanmenu.min.css">
    <!-- nivo.slider css -->
    <link rel="stylesheet" href="{{ asset('asset/css') }}/nivo-slider.css">
    <!-- owl.carousel css -->
...
<script src="{{ asset('asset/js') }}/vendor/jquery-1.12.3.min.js"></script>
<!-- bootstrap js -->
...
<!-- nivo.slider JS -->
<script src="{{ asset('asset/js') }}/jquery.nivo.slider.pack.js"></script>
<!-- simpleLens JS -->
<script src="{{ asset('asset/js') }}/jquery.simpleLens.min.js"></script>
<!-- jquery-ui js -->
